...
namespace UnitTestProject
{
    public class ExpressionTests
    {
        ...
        [Theory]
        [InlineData(1, "-y^2 + 4.5xy = 0")]
        [InlineData(2, "x^2 - y^2 + 4.5xy = 0")]
        [InlineData(3, "2x^2 - y^2 + 4.5xy = 0")]
        [InlineData(-1, "-2x^2 - y^2 + 4.5xy = 0")]
        public void Normalization(decimal firstTermMultiplier, string expected)
        {
            // Составляем выражение: [firstTermMultiplier]x^2 + 3.5xy + y - x^2 = y^2 - xy + y
